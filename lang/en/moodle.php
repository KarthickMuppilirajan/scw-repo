...
$string['passwordsdiffer'] = 'Passwords Don\'t match. Please re-enter';
...
$string['telephone_help'] = 'This number will be validated. Ex:  +44 1632 960344, 01632 960344, +1(202)-555-0187
 ';
$string['profession'] = 'Register as';
$string['confirm_email'] = 'Confirm Email';
$string['submit'] = 'Submit';
$string['reset'] = 'Reset';

$string['firstname_required'] = 'Please enter your first name';
$string['lastname_required'] = 'Please enter your last name';
$string['email_required'] = 'Please enter your email';
$string['confirm_email_required'] = 'Please enter your confirm email';
$string['phone_required'] = 'Please enter your telephone no';
$string['profession_required'] = 'Please select register as';
$string['firstname_valid'] = 'Please enter valid first name';
$string['middlename_valid'] = 'Please enter valid middle name';
$string['lastname_valid'] = 'Please enter valid last name';
$string['email_required'] = 'Please enter your email';
$string['confirm_email_required'] = 'Please enter your confirm email';
$string['email_valid'] = 'Please enter valid email ID';
$string['confirm_email_valid'] = 'Please enter valid email ID';
$string['match_email'] = 'Email ID doesnt match';
$string['phone_required'] = 'Please enter your telephone no';
$string['phone_valid'] = 'Please enter valid telephone no';

$string['test_subject'] = 'Test mail on {$a}';
$string['test_content'] = '<h1>{$a->heading}</h1><p>Test mail on {$a->date}</p>';
$string['payment_mail_subject'] = 'Payment mail: Subscribe to SCW';
$string['payment_mail_content'] = '<div style="width:100%; background-color:#999; height:50px;"><h1>Header</h1></div>
<div style="color:#09F; font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:justify;"><h1>Subscription</h1><p> Hi {$a->name}</p><p>Subscribe to SCW for {$a->amount} per year</p><p><a href="{$a->link}">Click here to pay</a></p></div>
<div style="width:100%; background-color:#93C; height:50px;"><h5>Footer</h5></div>';
$string['payment_content_recent_graduates']='<p>Subscribe to SCW for {$a->amount} per year</p>';
$string['subscription'] = 'Subscribe to SCW';
$string['pay'] = 'Pay now';
$string['setpassword'] = 'Set password';
$string['emailpasswordconfirmmaybesent'] = '<p>If you supplied a correct email address then an email should have been sent to you.</p>
   <p>It contains easy instructions to confirm and complete this password change.
If you continue to have difficulty, please contact the site administrator.</p>';
...
A password reset was requested for your account at {$a->sitename}.
...
$string['send']='Send';
$string['mustconfirm'] = '';
$string['emailconfirmsent'] = 'Your profile is currently being reviewed and is pending approval. If you need assistance please contact info@supplychainwire.com';
$string['emailpasswordconfirmsent'] = 'You are not approved, please contact administrator';

$string['confirmednot'] = 'Your registration has not yet been athorized';
$string['confirm_password'] = 'Confirm Password';
$string['setpasswordinstructions'] = '';

$string['payment_mail_content'] = '
    ...
    <tr>
      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
		  ...
		  <tr><td><p style="font-family: arial;font-size:18px;font-weight:normal;color:#8c181d;padding:0;margin:0 0 0px 0;width:100%;line-height:16px;">Hi {$a->name},</p>
<p>Subscribe to SCW for &pound; {$a->amount} per year</p><p><a href="{$a->link}">Click here to pay</a></p>
</td></tr>
</tbody></table></td></tr>
<tr><td>&nbsp;</td></tr>
		  <tr>
              ...
              <tbody>
                <tr>
                  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                        <td align="center" valign="middle"><p style="font-family: arial;font-size:12px;font-weight:bold;color:#ffffff;padding:0;margin:0 0 12px 0;width:100%;line-height:16px;"><a href="'.$CFG->wwwroot.'/privacy_policy.php" style="font-weight:bold;color:#ffffff;text-decoration: none;">Privacy Policy</a>  |  <a href="'.$CFG->wwwroot.'/disclaimer.php" style="font-weight:bold;color:#ffffff;text-decoration: none;">Disclaimer</a>  |  <a href="'.$CFG->wwwroot.'/terms_of_service.php" style="font-weight:bold;color:#ffffff;text-decoration: none;">Terms of Service</a>  |  <a href="'.$CFG->wwwroot.'/contactus.php" style="font-weight:bold;color:#ffffff;text-decoration: none;">Contact</a></p></td>
                      </tr>
                      <tr>
                        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tbody>
    ...
    <tr>
      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
		  ...
		  <tr><td><p style="font-family: arial;font-size:18px;font-weight:normal;color:#8c181d;padding:0;margin:0 0 0px 0;width:100%;line-height:16px;">Hi {$a->firstname},</p>
...
(This link is valid for {$a->resetminutes} minutes from the time this reset was first requested)</td></tr>
</tbody></table></td></tr>
<tr><td>&nbsp;</td></tr>
		  <tr>
            <td align="left" valign="top" bgcolor="#313a3e"><table width="100%" border="0" cellspacing="10" cellpadding="10">
...
';
$string['emailresetconfirmation_new'] = '
<div style="background-color:#F0F0F0">
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
...
Welcome to Supply Chain Wire. Please go to the following web address to setup your password
...
$string['emailpasswordconfirmmaybesent'] = '<p>If the email address is correct then an email should have been sent to you.</p>
   <p>It contains easy instructions to confirm and complete this password change.
If you continue to have difficulty, please contact the site administrator.</p>';
$string['registered_status'] = 'Are you registered member of SCW';
$string['message'] = 'Message';
$string['message_required'] = 'Please enter your message';
$string['country_required'] = 'Please select your country';
$string['contactus_mail_subject'] = 'Enquiry recieved on {$a}';
$string['contactus_mail_content'] = '
<div style="background-color:#F0F0F0">
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
		  ...
		  <tr><td><p style="font-family: arial;font-size:18px;font-weight:normal;color:#8c181d;padding:0;margin:0 0 0px 0;width:100%;line-height:16px;">Hi {$a->name},</p>
		  <p>Enquiry recieved, Please find the details.</p>
<p>{$a->mail}</p>
...
$string['deactivate_comments'] = 'How can we make you stay ? <br> Appreciate your comments and critics';
$string['deactivate_comments_required'] = 'Please type your comments and critics';
$string['deactivate_mail_subject'] = 'Acount deactivated by {$a}';
$string['deactivate_mail_content'] = '
<div style="background-color:#F0F0F0">
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
		  ...
		  <tr><td><p style="font-family: arial;font-size:18px;font-weight:normal;color:#8c181d;padding:0;margin:0 0 0px 0;width:100%;line-height:16px;">Hi Admin,</p>
		  <p>An user deactivated his/her account from SCW, please find the details.</p>
<p>{$a->mail}</p>
...
';
$string['sniff_keyword'] = 'Searchable Profile';
$string['sniff_keyword_help'] = 'Enter your skills specialization';
