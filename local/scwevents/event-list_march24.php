...
if(isset($_REQUEST['keyword']))
{
	...
	$sql="SELECT * FROM {local_scwevents} WHERE event_status = '1' AND event_startdate > $time and event_name like '%$keyword%' ORDER BY event_startdate ASC LIMIT 0,10";
}
else
{
	$sql="SELECT * FROM {local_scwevents} WHERE event_status = '1' AND event_startdate > $time ORDER BY event_startdate ASC LIMIT 0,10";
}
