...
<div style="color:#560c25; font-weight:600; font-size:12px; margin-left:35px;">20 - 23 Mar 2017 at London, VA, UK</div>
</div>
<div class="col-lg-2 ">
<button id="share" class="btn btn-sm btn-ashblk pull-right"><i class="fa fa-mail-forward"></i> Share</button>
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<div id="sharebutton" style=" display:none;margin-left:70px; " class="addthis_inline_share_toolbox"></div>
</div>
</div>
...
<?php 
$sql="SELECT * FROM {local_scwevents} WHERE event_status = '1' AND event_startdate > $time ORDER BY event_startdate";
...
{	
	...
	$event_description=trim(substr($event_description,0,500));
        ...
        <div class="carousel-inner">
          <div class="item  active">
            <div class="row">
              ...
              <h6>1Lorem ipsum dolor sit amet, consectetur adipiscing elit 1.</h6>              
            ...
            <span class="month-disp"><strong>FEB</strong></span>
              ...
              <div class="col-lg-3">
              <div class="otherintervw-innerslidr">
              <h6>2Lorem ipsum dolor sit amet, consectetur adipiscing elit 1.</h6>              
              <div class="calendar-blk">
            <span class="date-disp"><strong>07</strong></span><br>
            <span class="month-disp"><strong>FEB</strong></span>
            </div>
              ...
              <div class="col-lg-3">
              <div class="otherintervw-innerslidr">
              <h6>3Lorem ipsum dolor sit amet, consectetur adipiscing elit 1.</h6>              
              <div class="calendar-blk">
            <span class="date-disp"><strong>07</strong></span><br>
            <span class="month-disp"><strong>FEB</strong></span>
            </div>
              ...
              <div class="col-lg-3">
              <div class="otherintervw-innerslidr">
              <h6>4Lorem ipsum dolor sit amet, consectetur adipiscing elit 1.</h6>              
              <div class="calendar-blk">
            <span class="date-disp"><strong>07</strong></span><br>
            <span class="month-disp"><strong>FEB</strong></span>
            </div>
