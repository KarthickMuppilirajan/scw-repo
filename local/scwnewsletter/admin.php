...
<div class='form-inline row'>
  <div class='form-group col-sm-10 col-md-5 col-lg-3 mform'>
    ...
    <select class='form-control' name="event_action">
    ...
    <div class='form-group col-sm-12 col-md-8 col-lg-7'>
	    <form class="form-inline" name="frmaddevent" action="<?php echo $searchurl; ?>" method="get">
          <input type='text' placeholder='Type text' name='searchtext' class='form-control' value="<?php echo $searchtext; ?>" />
...
require(['jquery'], function( $ ) {
  ...
  $("#frmeventstatus").submit(function(){
	  ...
	  if(eac==""){
		  ...
		  $("#event_action_error").html("Please choose any one banner").removeClass("hide");
		  cnt++;
	  }
