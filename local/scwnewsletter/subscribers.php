...
$title = 'SupplyChainWire - Subscribers List';


$searchtext = optional_param('searchtext','',PARAM_TEXT);
$pageurl = new moodle_url("/local/scwnewsletter/subscribers.php");
...
$PAGE->set_url('/local/scwnewsletter/subscribers.php');
$PAGE->set_pagelayout('admin');
$PAGE->set_title($title);


if(!has_capability('local/scwnewsletter:viewsubscribers', $syscontext) ){
...
<div class='form-inline row'>
    ...
    <div class='form-group col-xs-12 col-sm-10 col-md-7 col-lg-8'>
	    <form class="form-inline" name="frmaddevent" action="<?php echo $pageurl; ?>" method="get">
		  ...
		  <button type="submit" class="form-control" id="btn-search-subscribers"><?=get_string('search', 'local_scwnewsletter');?></button>
	    </form>	
    </div>
...
<?php
echo $renderer->subscribers_list();
