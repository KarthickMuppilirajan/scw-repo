...
class scwinterviews_edit_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('text','interview_heading', 'Heading','maxlength="100" size="50"', array('id'=>'userId'));
	...
	//	$mform->addRule('interview_heading', get_string('err_lettersonly','local_scwinterviews'), 'lettersonly', null, 'client');
		...
		$mform->addElement('editor', 'summary_editor', get_string('summary_editor', 'local_scwinterviews'), null, $editoroptions, array('id'=>'id_summary_editor'));
	...
	//	$mform->addRule('interview_company', get_string('err_lettersonly','local_scwinterviews'), 'lettersonly', null, 'client');
		...
		$buttonarray[] = &$mform->createElement('button', 'preview', get_string('preview', 'local_scwinterviews'),$classarray);
