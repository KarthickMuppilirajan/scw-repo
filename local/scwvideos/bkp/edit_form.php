...
class videos_edit_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addElement('filemanager', 'video_thumb', $fld , null, $thumboptions);
		$mform->addRule('video_thumb', $missingfld, 'required', null, 'client');
        ...
        $buttonarray[] = &$mform->createElement('submit', 'preview', get_string('preview', 'local_scwvideos'), $classarray);
		$buttonarray[] = &$mform->createElement('submit', 'publish', get_string('publish', 'local_scwvideos'), $classarray);
        $buttonarray[] = &$mform->createElement('button', 'clear', get_string('clear', 'local_scwvideos'));
