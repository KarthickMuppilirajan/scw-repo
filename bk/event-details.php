...
<?php 
$sql="SELECT * FROM {local_scwevents} WHERE event_status = '1' AND event_startdate > $time  and id !=$id ORDER BY event_startdate ASC";
$totalcount = $DB->count_records_sql("SELECT COUNT('x') FROM {local_scwevents} WHERE event_status = '1' AND event_startdate > $time  and id !=$id");
