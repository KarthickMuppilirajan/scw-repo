...
if ($usernew = $userform->get_data()) {
    ...
    if(!empty($userdetails)){
		...
		if($userdetails->profession==1){
            ...
            $userdetails->industry_others = $usernew->industry_others;
			$usernew->functional_area_others =  ($usernew->functional_area=="other") ? $usernew->functional_area_others : '';
            $userdetails->functional_area_others = $usernew->functional_area_others;
        }
...
require(['jquery'], function( $ ) {
    $(".btn-remove").on('click', function(){
		...
		$("input[name=removebtn]").val("Remove");
    ...
    $(".btn-remove1").on('click', function(){
		...
		$("input[name=removebtn1]").val("Remove");
	...
	$("#id_addmorebutton").on('click',function(){
		 $("input[name=addmore]").val("Addmore");
		 $("#mform1").submit();
	});
	
	$("#id_addmorebutton1").on('click',function(){
		 $("input[name=addmore1]").val("Addmore");
		 $("#mform1").submit();
	});
