...
class login_change_password_form extends moodleform {
    ...
    function definition() {
        ...
        $mform->addRule('password', 'Please enter Current password', 'required', null, 'client');
        $mform->setType('password', PARAM_RAW);

        $mform->addElement('password', 'newpassword1', get_string('newpassword'));
        $mform->addRule('newpassword1', 'Please enter New password', 'required', null, 'client');
        $mform->setType('newpassword1', PARAM_RAW);

        $mform->addElement('password', 'newpassword2', get_string('newpassword').' ('.get_String('again').')');
        $mform->addRule('newpassword2', 'Please enter New password (again)', 'required', null, 'client');
